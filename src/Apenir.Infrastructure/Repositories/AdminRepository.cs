    ...
    public class AdminRepository : IAdminRepository
    {
        ...
        public async Task<User?> GetByIdAsync(Guid id, CancellationToken cancellationToken = default)
        {
            ...
            return await _context.Users
                .AsNoTracking()
                .FirstOrDefaultAsync(u => u.Id == userId && !u.IsDeleted && u.Role != UserRole.Customer, cancellationToken);
        }
        ...
        public async Task<User?> GetByEmailAsync(string email, CancellationToken cancellationToken = default)
        {
            ...
            return await _context.Users
                .AsNoTracking()
                .FirstOrDefaultAsync(u => u.Email != null && u.Email.ToLower() == lowercaseEmail && !u.IsDeleted && u.Role != UserRole.Customer, cancellationToken);
        }
        ...
        public async Task<bool> ExistsAsync(string email, CancellationToken cancellationToken = default)
        {
            ...
            return await _context.Users
                .AnyAsync(u => u.Email != null && u.Email.ToLower() == lowercaseEmail && !u.IsDeleted && u.Role != UserRole.Customer, cancellationToken);
        }
